...
<!--              </div>-->
              <div class="modal__form-row">
                ...
                <label class="modal__form-label" for="region">Регион</label>
                <input class="modal__form-input" type="text" v-model="address.region"
                       name="region" placeholder="Регион"
                       id="region">
                </div>
                <div class="modal__form-block">
                <label class="modal__form-label" for="street">Улица, дом</label>
                <input class="modal__form-input" type="text" v-model="address.street"
                       name="street" placeholder="Улица, дом"
                       id="street">
                </div>
              </div>
               <div class="modal__form-row">
                  <div class="modal__form-block">
                  <label class="modal__form-label" for="city">Город</label>
                  <input class="modal__form-input" type="text" v-model="address.city"
                         name="city" placeholder="Город"
                         id="city">
                  </div>
                  <div class="modal__form-block">
                  <label class="modal__form-label" for="apartment">Квартира</label>
                  <input class="modal__form-input" type="text" v-model="address.apartment"

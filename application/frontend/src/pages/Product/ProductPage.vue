...
<div class="product">
  <div class="product__path-wrapper">
    ...
    <span class="product__path-last"> Акустическая гитара BEST 21F </span>
  </div>
  ...
  <section class="product__main">
    <div class="main__block container">
      ...
      <div class="main__third-column">
        ...
        <div class="main__title">Акустическая гитара BEST 21F</div>

        <div class="main__price">
          <span class="main__price-current"> 19 700 ₽ </span>
        ...
        <ul class="main__list">
          ...
          <li class="main__list-elem">
            <span class="main__list-title">Задняя дека </span>
            <span class="main__line-dotted"></span>
            <span class="main__list-info">Информация</span>
          </li>
          <li class="main__list-elem">
            <span class="main__list-title">Количество ладов </span>
            <span class="main__line-dotted"></span>
            <span class="main__list-info">Информация</span>
          </li>
          <li class="main__list-elem">
             <span class="main__list-title">Материал корпуса </span>
            <span class="main__line-dotted"></span>
            <span class="main__list-info">Информация</span>
          </li>
          <li class="main__list-elem">
            <span class="main__list-title">Цвет </span>
            <span class="main__line-dotted"></span>
            <span class="main__list-info">Информация</span>
          </li>
        </ul>
    ...
    <div class="nav__block container">
      <ul class="nav__list">
        ...
        <li class="nav__list-elem">
          ...
          >Инструкции и документация</button>
        </li>
      </ul>
      ...
      <div class="nav__description wrapper" v-if="this.currentLink ==='Описание'">
        ...
        <div class="nav__second-column column">
          <p class="nav__description-info">Струнный щипковый музыкальный инструмент.
          Применяется в качестве аккомпанирующего или сольного инструмента во многих стилях и направлениях музыки,
          среди которых романс, блюз, кантри, фламенко, рок, джаз. Изобретённая в XX веке электрическая гитара произвела
          значительные изменения в музыке и тем самым оказала сильное влияние на массовую культуру.
          Также есть классическая гитара, гитара фламенко, испанская гитара и некоторые другие виды.</p>
        </div>
      </div>

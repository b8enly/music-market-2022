    ...
    <div class="card">
      <div class="card_header">
        ...
        <div class="wrapper_favorite">
          <img class="card_favorite" :src="require('../assets/icon/iconHeartBlack.svg')" alt="favorite" height="18"
               width="19"/> <!--  избранное -->
        </div>
      </div>
      <div class="card_guitar">
        <img :src="require('../assets/img/imgGuitar.png')" alt="img" height="238" width="88"/>
        <!--   картинка гитары -->
      </div>
